...
//                var grav = 0;
                ...
                if(entity.x < 0 || entity.x > arjs.canvas.width){
                    entityG.speed[0] = entity.x < 0 ? -entityG.speed[0] : -(entityG.speed[0] + 0);
                    entity.x = entity.x < 0 ? 0 : arjs.canvas.width;
                }
                if(entity.y < 0 || entity.y > arjs.canvas.height){
                    entityG.speed[1] = entity.y < 0 ? -entityG.speed[1] : -(entityG.speed[1] + 0);
                    entity.y = entity.y < 0 ? 0 : arjs.canvas.height;
                }
                if(
