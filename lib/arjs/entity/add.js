arjs.extend({
    ...
    defines: function(info){
        ...
        newEntity.addPixel == undefined ? newEntity.addPixel = [0,0,0,0] : false;

        newEntity.drawBefore == undefined ? newEntity.drawBefore = new Array() : false;
        newEntity.drawAfter == undefined ? newEntity.drawAfter = new Array() : false;
