window.arjs =
{
    ...
    system:
    {
        ...
        arjsUrl: document.getElementsByTagName('script')[document.getElementsByTagName('script').length-1].src,
        loadRequiredScript: function (url)
        {
            if(arjs.system.loadedScript[url] == undefined)
            {
                ...
                script.src = url + '?' + Math.round(Math.random() * 100000000);
...
arjs.system.arjsUrl = arjs.system.arjsUrl.substring(0, arjs.system.arjsUrl.lastIndexOf("/")+1);
