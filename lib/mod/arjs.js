window.arjs =
{
    ...
    extend:function(info)
    {
        ...
        var nestedArr = info.name != undefined ? info.name.split('.') : arjs.system._currentName.split('.');
...
arjs.extend({
    name: 'init',
    required: [
        '%arjsBase%preload.mod1'
    ],
    defines: function(){

    },
    run: function (){
        console.log(arjs.system.testVar);
//        arjs.preload.image('media/testOver.png')
    }
});