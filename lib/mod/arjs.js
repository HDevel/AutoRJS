window.arjs =
{
    system:
    {
        ...
        loadRequiredScript: function (url,name)
        {
            if(arjs.system.loadedScript[url] == undefined)
            {
                ...
                script.onload = function(){
                    console.log(this.src.replace(arjs.system.baseUrl,'').replace(arjs.system.arjsUrl,''))
                    arjs.system.updateModuleRunQueue(name);
                };
                script.src = url;
    ...
    extend:function(info)
    {
        ...
        if(info.required != undefined)
        {
            for(var f in info.required)
            {
                ...
                arjs.system._currentName = info.required[f].replace('%siteBase%','').replace('%arjsBase%','');
                ...
                arjs.system.loadRequiredScript(url,arjs.system._currentName);
            }
        }
        var obj = arjs;
...
//        console.log('---------------------')
//        console.log(arjs.system.info)
//        console.log(arjs.system._parentName)
//        console.log(arjs.system._currentName)
...
//        });
//        arjs.preload.progress(function(info){
//            console.log(info);
//        })
    }
});